"""virtualconnection_19018 URL Configuration
...
admin.site.site_header = "VirtualConnection"
admin.site.site_title = "VirtualConnection Admin Portal"
admin.site.index_title = "VirtualConnection Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="VirtualConnection API",
        default_version="v1",
        description="API documentation for VirtualConnection App",
    ),
    public=True,
